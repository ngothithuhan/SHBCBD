...
begin
    ...
    SELECT o.ACSELLER,o.ACBUYER,o.SYMBOL,o.EXECAMT,o.CONFIRMNO ,o.FEEBUYER,o.TAXBUYER, p.shortname
    INTO l_acseller,l_acbuyer,l_symbol,l_execamt,l_confirmno,l_FEEBUYER,l_TAXBUYER, l_product_name
    FROM OXMAST o
    ...
    'KH tat toan '||p_amount ||' '||l_symbol||' cua lenh SELL'||p_orderid, 2, NULL, NULL, 0, 0, 0);
    ...
    'Tien tat toan ' || p_amount || ' ' || l_symbol || ' cua lenh SELL '|| p_orderid, l_acbuyer ||lpad(l_autoid_symbol,6,0), l_autoid_symbol,
    ...
    IF p_fee <> 0 THEN
            ...
            (AUTOID, TXNUM, TXDATE, TLTXCD, BKDATE, TRDESC, ACCTNO, CODEID, SYMBOL, SRTYPE, TXCD, NAMT, CAMT, "REF", DELTD, ACCTREF, LVEL)
            VALUES(seq_IVTRAN.nextval, p_txnum, p_txdate, p_tltxcd,p_busdate,
            'Phi ban  ' || p_amount || ' ' || l_symbol || ' cua lenh SELL '|| p_orderid,
        ...
        IF p_tax <> 0 THEN
            ...
            (AUTOID, TXNUM, TXDATE, TLTXCD, BKDATE, TRDESC, ACCTNO, CODEID, SYMBOL, SRTYPE, TXCD, NAMT, CAMT, "REF", DELTD, ACCTREF, LVEL)
            VALUES(seq_IVTRAN.nextval, p_txnum, p_txdate, p_tltxcd,p_busdate,
            'Thue ban ' || p_amount || ' ' || l_symbol || ' cua lenh SELL '|| p_orderid,
            l_acbuyer ||lpad(l_autoid_symbol,6,0), l_autoid_symbol,
    ...
    p_tax,p_fee,p_tlid,p_offid,l_seq,l_contract_no,'N','N','N','N','N','N','N');
