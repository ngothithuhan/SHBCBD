...
DROP TABLE agencymemo
/

CREATE TABLE agencymemo
    (autoid                         NUMBER NOT NULL,
    agency_code                    VARCHAR2(50 BYTE),
    agency_name                    VARCHAR2(250 BYTE),
    agency_type                    VARCHAR2(50 BYTE),
...
CREATE OR REPLACE TRIGGER trg_alertcontent_afterinsert
 AFTER
  INSERT
 ON alertcontent
...
begin
  ...
  pkgctx := plog.init('trg_alertcontent_afterinsert',
                      plevel            => nvl(logrow.loglevel, 30),
                      plogtable         => (nvl(logrow.log4table, 'N') = 'Y'),
                      palert            => (nvl(logrow.log4alert, 'N') = 'Y'),
                      ptrace            => (nvl(logrow.log4trace, 'N') = 'Y'));

  plog.setBeginSection(pkgctx, 'trg_alertcontent_afterinsert');

  txpks_notify.prc_system_logevent(:newval.autoid, 'ALERTS', 
            'ALL' || '~#~' ||
            'ALL' || '~#~' ||
            'ALL', 'R','INSERT ALERTS ' || :newval.autoid);
            
  plog.setEndSection(pkgctx, 'trg_alertcontent_afterinsert');
...
CREATE TABLE assetdtl
    ...
    intratefltnotes                VARCHAR2(4000 BYTE),
    ...
    collateral                     VARCHAR2(50 BYTE),
    intparent                      CHAR(1 BYTE))
  SEGMENT CREATION IMMEDIATE
  NOPARALLEL
  NOLOGGING
  MONITORING
...
DROP TABLE blockaccfee
/

CREATE TABLE blockaccfee
    (autoid                         NUMBER,
    txnum                          VARCHAR2(200 BYTE),
    txdate                         DATE,
    tlid                           VARCHAR2(200 BYTE),
    offid                          VARCHAR2(200 BYTE),
...
DROP TABLE blockcfmasthist
/

CREATE TABLE blockcfmasthist
    (custodycd                      VARCHAR2(200 BYTE),
    txdate_block                   DATE,
    txnum_block                    VARCHAR2(200 BYTE),
    systemdate_block               DATE,
    feeblock                       NUMBER,
    txdate_unblock                 DATE,
    txnum_unblock                  VARCHAR2(200 BYTE),
    systemdate_unblock             DATE)
  SEGMENT CREATION IMMEDIATE
  NOPARALLEL
  LOGGING
  MONITORING
...
DROP TABLE buyoption_exec
/

CREATE TABLE buyoption_exec
...
DROP TABLE changecarebyhist
/

CREATE TABLE changecarebyhist
    (custodycd                      VARCHAR2(200 BYTE),
    txdate                         DATE,
    txnum                          VARCHAR2(200 BYTE),
    systemdate                     DATE,
    oldcareby                      VARCHAR2(200 BYTE),
    newcareby                      VARCHAR2(200 BYTE))
  SEGMENT CREATION IMMEDIATE
  NOPARALLEL
  LOGGING
  MONITORING
...
CREATE TABLE cimast
    ...
    sid                            VARCHAR2(20 BYTE),
    balance                        NUMBER(38,0),
    receiving                      NUMBER(38,0),
    careceiving                    NUMBER(38,0),
    netting                        NUMBER(38,0),
    blocked                        NUMBER(38,0),
    status                         VARCHAR2(1 BYTE),
    pstatus                        VARCHAR2(4000 BYTE),
    lastchange                     TIMESTAMP (6),
    floatamt                       NUMBER(38,0),
    ivsecured                      NUMBER)
  SEGMENT CREATION IMMEDIATE
  NOPARALLEL
  LOGGING
...
DROP TABLE coupon_ipo
/

CREATE TABLE coupon_ipo
    (autoid                         NUMBER,
    symbol                         VARCHAR2(20 BYTE),
    custodycd                      VARCHAR2(20 BYTE),
    settdate                       DATE,
...
CREATE TABLE coupon_receive
    ...
    coupon_received                NUMBER,
    taxpaid                        NUMBER,
    amountpaid                     NUMBER,
    percent                        NUMBER,
    overinterestpaid               NUMBER)
  SEGMENT CREATION IMMEDIATE
  NOPARALLEL
  LOGGING
  MONITORING
...
DROP TABLE coupon_receive_detail
/

CREATE TABLE coupon_receive_detail
    (autoid                         NUMBER,
    custodycd                      VARCHAR2(100 BYTE),
    symbol                         VARCHAR2(100 BYTE),
    periodno                       NUMBER,
...
DROP TABLE cstb_rpt_term_defn
/

CREATE TABLE cstb_rpt_term_defn
    (min_day                        NUMBER,
    max_date                       NUMBER,
...
DROP TABLE distibute_seri
/

CREATE TABLE distibute_seri
    (autoid                         NUMBER NOT NULL,
    txnum                          VARCHAR2(100 BYTE),
    txdate                         DATE,
    bkdate                         DATE,
    papertype                      VARCHAR2(30 BYTE),
    serifrom                       VARCHAR2(50 BYTE),
    serito                         VARCHAR2(50 BYTE),
    status                         VARCHAR2(1 BYTE),
    brid                           VARCHAR2(10 BYTE),
    tlid                           VARCHAR2(10 BYTE),
    chkid                          VARCHAR2(10 BYTE),
    symbol                         VARCHAR2(200 BYTE))
  SEGMENT CREATION IMMEDIATE
  NOPARALLEL
  LOGGING
...
DROP TABLE distibute_seri_dtl
/

CREATE TABLE distibute_seri_dtl
    (autoid                         NUMBER,
    txnum                          VARCHAR2(100 BYTE),
    txdate                         DATE,
    bkdate                         DATE,
...
DROP TABLE focmdmenu_bk_20210908
/

CREATE TABLE focmdmenu_bk_20210908
    (cmdid                          VARCHAR2(6 BYTE) NOT NULL,
    prid                           VARCHAR2(6 BYTE),
    lev                            NUMBER(*,0),
    "last"                         VARCHAR2(1 BYTE),
...
DROP TABLE intschdreviewhist
/

CREATE TABLE intschdreviewhist
    (symbol                         VARCHAR2(100 BYTE),
    reviewdt                       DATE,
    old_intrate                    NUMBER,
    new_intrate                    NUMBER)
...
CREATE TABLE oxmasthist
    ...
    promotioncode                  VARCHAR2(100 BYTE),
    beforeadjprice                 NUMBER,
    pendingsoldqtty                NUMBER,
    isissued                       CHAR(1 BYTE),
    buyerbank                      VARCHAR2(200 BYTE),
    buyercitybank                  VARCHAR2(200 BYTE),
    buyercash                      VARCHAR2(200 BYTE),
    term                           NUMBER,
...
DROP TABLE paper_stattrans
/

CREATE TABLE paper_stattrans
    (autoid                         NUMBER(*,0) NOT NULL,
    txnum                          VARCHAR2(100 BYTE),
    txdate                         DATE,
    bkdate                         DATE,
...
DROP TABLE paperimport_nh
/

CREATE TABLE paperimport_nh
    (autoid                         NUMBER NOT NULL,
    txnum                          VARCHAR2(100 BYTE),
    txdate                         DATE,
    bkdate                         DATE,
    papertype                      VARCHAR2(30 BYTE),
    serifrom                       VARCHAR2(60 BYTE),
    serito                         VARCHAR2(50 BYTE),
    status                         VARCHAR2(10 BYTE),
    tlid                           VARCHAR2(50 BYTE),
    chkid                          VARCHAR2(50 BYTE),
...
DROP TABLE paperimport_storage
/

CREATE TABLE paperimport_storage
    (autoid                         NUMBER,
    txnum                          VARCHAR2(100 BYTE),
    txdate                         DATE,
    bkdate                         DATE,
...
DROP TABLE paperissue
/

CREATE TABLE paperissue
    (autoid                         NUMBER(*,0) NOT NULL,
    txnum                          VARCHAR2(100 BYTE),
    txdate                         DATE,
    papertype                      VARCHAR2(30 BYTE),
    seri                           VARCHAR2(50 BYTE),
    brid                           VARCHAR2(50 BYTE),
    confirmno                      VARCHAR2(50 BYTE),
    tlid                           VARCHAR2(50 BYTE),
    chkid                          VARCHAR2(50 BYTE),
    status                         VARCHAR2(1 BYTE),
    close_desc                     VARCHAR2(100 BYTE))
  SEGMENT CREATION IMMEDIATE
  NOPARALLEL
  LOGGING
  MONITORING
...
DROP TABLE paperissuerfile
/

CREATE TABLE paperissuerfile
    (autoid                         NUMBER NOT NULL,
    branch                         VARCHAR2(50 BYTE),
    txdate                         DATE,
    lastchange                     TIMESTAMP (6),
    urlfile                        VARCHAR2(200 BYTE),
    tlid                           VARCHAR2(50 BYTE),
    delid                          VARCHAR2(50 BYTE),
    status                         VARCHAR2(30 BYTE),
    pstatus                        VARCHAR2(4000 BYTE),
    description                    VARCHAR2(500 BYTE))
  NOPARALLEL
...
DROP TABLE parentasset
/

CREATE TABLE parentasset
    (autoid                         NUMBER,
    issuerid                       VARCHAR2(200 BYTE),
    parentname                     VARCHAR2(200 BYTE),
    parentsymbol                   VARCHAR2(200 BYTE),
    lastchange                     TIMESTAMP (6),
    status                         VARCHAR2(3 BYTE),
    pstatus                        VARCHAR2(4000 BYTE),
    parentier                      VARCHAR2(4000 BYTE))
  SEGMENT CREATION IMMEDIATE
  NOPARALLEL
  LOGGING
  MONITORING
...
DROP TABLE parentassetdtl
/

CREATE TABLE parentassetdtl
    (autoid                         NUMBER,
    id                             NUMBER,
    issuerid                       VARCHAR2(200 BYTE),
    symbol                         VARCHAR2(200 BYTE))
...
DROP TABLE parentassetmemo
/

CREATE TABLE parentassetmemo
    (autoid                         NUMBER,
    issuerid                       VARCHAR2(200 BYTE),
    parentname                     VARCHAR2(200 BYTE),
    parentsymbol                   VARCHAR2(200 BYTE),
...
DROP TABLE parentier
/

CREATE TABLE parentier
    (autoid                         NUMBER,
    id                             NUMBER,
    issuerid                       VARCHAR2(200 BYTE),
    symbol                         VARCHAR2(200 BYTE))
...
CREATE TABLE product
    ...
    sellmax                        NUMBER,
    sellmin                        NUMBER,
    autorenew                      VARCHAR2(10 BYTE),
    notenoughterm                  VARCHAR2(10 BYTE),
    orderid                        VARCHAR2(100 BYTE),
    orgprdid                       NUMBER,
    clsdtl                         VARCHAR2(4000 BYTE))
  SEGMENT CREATION IMMEDIATE
  NOPARALLEL
  NOLOGGING
  MONITORING
...
DROP TABLE productclsdtl
/

CREATE TABLE productclsdtl
    (autoid                         NUMBER,
    id                             NUMBER,
    termcd                         VARCHAR2(1 BYTE),
    from                           NUMBER,
...
DROP TABLE productclsdtlmemo
/

CREATE TABLE productclsdtlmemo
    (autoid                         NUMBER,
    id                             NUMBER,
    termcd                         VARCHAR2(1 BYTE),
    from                           NUMBER,
...
begin
  ...
  SELECT cmdtype INTO v_cmdtype FROM rptmaster WHERE rptid=:newval.rptid;
 ...
 p_refrptfile := '';
  ...
  LOOP
    SELECT count(1) INTO v_count FROM rptmaster WHERE rptid=:newval.rptid;
    IF  v_count > 0 THEN
        ...
        if p_types(i) = 'PDF' then
          p_reportTemplate:=  p_RptTemplatePath ||p_reportTemplate||'.PDF';
          p_RptType :='PDF';
        else
     ...
     ELSE
        ...
        --Check template file
        if p_types(i) = 'PDF' then
          p_reportTemplate:=  p_RptTemplatePath ||:newval.rptid||'.PDF';
          p_RptType :='PDF';
        else
