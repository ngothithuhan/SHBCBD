...
CREATE TABLE sbsedefacct
    ...
    ipodiscrate                    NUMBER(20,5) DEFAULT 0,
...
DROP TABLE tltx_bk_20210826
/

CREATE TABLE tltx_bk_20210826
    (tltxcd                         VARCHAR2(4 BYTE) NOT NULL,
    txdesc                         VARCHAR2(400 BYTE),
    en_txdesc                      VARCHAR2(400 BYTE),
    limit                          FLOAT(64),
    ...
    bgcolor                        FLOAT(64),
    display                        VARCHAR2(1 BYTE),
    bkdate                         VARCHAR2(1 BYTE),
    adjallow                       VARCHAR2(1 BYTE),
    glgp                           VARCHAR2(2 BYTE),
    voucherid                      VARCHAR2(100 BYTE),
    ccycd                          CHAR(2 BYTE),
    runmod                         VARCHAR2(3 BYTE),
    restrictallow                  CHAR(1 BYTE),
    refobj                         VARCHAR2(20 BYTE),
    refkeyfld                      VARCHAR2(20 BYTE),
    msgtype                        VARCHAR2(20 BYTE),
    chkbkdate                      CHAR(1 BYTE),
    cfcustodycd                    CHAR(2 BYTE),
    cffullname                     CHAR(2 BYTE),
    visible                        VARCHAR2(1 BYTE),
    chgtypeallow                   VARCHAR2(1 BYTE),
    chksingle                      VARCHAR2(60 BYTE),
    foallow                        VARCHAR2(1 BYTE))
  SEGMENT CREATION IMMEDIATE
  NOPARALLEL
  NOLOGGING
  MONITORING
